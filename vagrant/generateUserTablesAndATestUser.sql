...
INSERT INTO auth_role VALUES (4,'TEACHER_USER','This user has access to site, after login - teacher user');
...
insert into auth_user_role (auth_user_id, auth_role_id) values ('1','4');

# username: admin@gmail.com password: abc123ABC