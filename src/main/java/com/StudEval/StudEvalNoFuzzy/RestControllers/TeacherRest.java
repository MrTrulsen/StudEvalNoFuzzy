...
public class TeacherRest {
    ...
    @RequestMapping("/getNameOfCourse/{evalId}")
    public String getNameOfCourse(@PathVariable Integer evalId){
        String courseName = mainRepository.getCourseNameFromEval(evalId);
        return courseName;
    }
